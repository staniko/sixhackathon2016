...
app.get('/getContract', function (req, res) {
    ...
    /* connection */
    var hostAddress = "http://localhost:8545";
    ...
    var cocoa = cocoaContract.new(title, startDate, endDate, bitcoinUSDValue, bitcoinUSDValue, {from:web3.eth.accounts[0], data: cocoaCompiled.cocoa.code, gas: 600000}, function(e, blockchainContract){
        if(!e) {
